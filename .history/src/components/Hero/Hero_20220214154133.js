...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      <button className="button-49" role="button" style={{marginBottom:'5rem'}} onClick={() => window.location = 'https://drive.google.com/file/d/1meqIBm1iw639fvehc_IxvUkhhdO0P-57/view?usp=sharing'}>Learn More</button>
