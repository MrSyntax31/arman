...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      <button className="button-49" role="button" style={{marginBottom:'5rem'}} onClick={() => window.location = 'https://drive.google.com/file/d/1Xlv5p9YnkgI1vwhJduUrrswRMhRMraPT/view?usp=sharinghttps://drive.google.com/file/d/1Xlv5p9YnkgI1vwhJduUrrswRMhRMraPT/view?usp=sharing'}>Resume</button>
