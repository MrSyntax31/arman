                    ...
                    <div className="row  ">
                      <div className="col-lg-3 col-md-4">
                        <div className="icon-box">
                          <img src="https://www.svgrepo.com/show/355190/reactjs.svg" className="w-25 mx-auto d-block"/>
                          <SectionText> React / React Native</SectionText>
                        </div>
                      </div>
                      <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                        <div class="icon-box">
                          <img src="https://www.svgrepo.com/show/373595/firebase.svg" className="w-25 mx-auto d-block"/>
                          <h3>Firebase</h3>
                        </div>
                      </div>
                      <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
