                    ...
                    <div className="row justify-content-md-center">
                      ...
                      <div className="col">
                        <div className="icon-box">
                          ...
                          <h3 className="m-1">Figma</h3>
                        </div>
                      </div>

                      <div className="col">
                        <div className="icon-box">
                            <img src="https://developers.adalo.com/img/adalo-logo-black.png" className="mx-auto d-block" width='50px'/>
                            <h3 className="m-1">Adalo</h3>
                        </div>
                      </div>
