    ...
    <SectionText>
      Here are some technologies that I use to build web applications.
                    ...
                    <div className="row">
                        ...
                        <SkillsLinks className="lni lni-code"></SkillsLinks>
                        <SkillsTitle>Programming</SkillsTitle>
                        <Skills>
                              Computer programmer skills are methods and processes that provide computers with instructions on what actions to perform. Collectively known as “code,” these instructions are written by computer programmers to solve problems or perform specific tasks.</Skills>
