...
import { Box, Boxes, Skills, SkillsParagraph, SkillsLinks } from './TechnologiesStyles';
    ...
    <SectionText>
      Here are some technologies that I use to build web applications.
                    ...
                    <div className="row">
                        ...
                        <h3>Programming</h3>
                        <p>
                              Computer programmer skills are methods and processes that provide computers with instructions on what actions to perform. Collectively known as “code,” these instructions are written by computer programmers to solve problems or perform specific tasks.</p>
                        ...
                        <h3>Designing</h3>
                        <p>Graphic designer skills are various artistic and creative skills and abilities needed to excel in a graphic design role. A graphic designer may work in-house at a design or advertising agency, in the marketing department of an organization or independently as a freelance contractor. They'll build visual print or digital content for clients that communicates the brand's message or story using visually appealing images, colors and fonts.</p>
