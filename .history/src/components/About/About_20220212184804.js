...
const About = () => {
  ...
  return (
    ...
    <div className="meta">
      <div className="photo" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/arman.jpg?alt=media&token=581988eb-b443-4009-9109-e2b4b6a6ad5c"></div>
