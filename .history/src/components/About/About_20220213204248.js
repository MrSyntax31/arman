          ...
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-4">
              ...
              <div className="hidden lg:block relative w-full md:w-1/2 -mr-40 mt-20">
                <div className="w-3/4 ">
                  <img src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/arman.jpg?alt=media&token=581988eb-b443-4009-9109-e2b4b6a6ad5c" alt="avatar" className="mx-auto d-block shadow hover08" style={{width:'100%', maxWidth:'300px', height:'auto'}} />
