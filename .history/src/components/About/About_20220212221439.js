            ...
            <div className="col-xs-12 col-sm-8">
              ...
              <figure className="flex">
                      ...
                      <article className="col p-2 m-2">
                        ...
                        My hobbies include playing video games, watching anime, and playing volleyball. I'm also a fan of the anime <strong className="fst-italic">Attack on a Titan</strong> and <strong class="fst-italic">One Piece</strong>.
